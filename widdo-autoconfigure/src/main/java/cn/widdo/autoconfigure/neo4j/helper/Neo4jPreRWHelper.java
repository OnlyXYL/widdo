...
public class Neo4jPreRWHelper {
	...
	public Result<List<Map<String, Value>>> query(Map<String, Object> param) {
		...
		Map<String, Object> map = Optional.ofNullable(param.get("map")).map(BeanUtils::<Map<String, Object>>cast)
				.orElse(null);
	...
	public Result<List<Map<String, Value>>> execute(Map<String, Object> param) {
		...
		Map<String, Object> map = Optional.ofNullable(param.get("map")).map(o -> (Map<String, Object>) o)
				.orElse(new HashMap<>());
