...
public interface WiddoResultInterface<T, R> {
	...
	enum HADOOP implements WiddoResultInterface<Object, WiddoResult> {
		...
		HDFS {
			@Override
			public WiddoResult wrapper(Object o) {
				return WiddoResult.response(IResultInterface.HadoopEnum.SUCCESS, o);
			}
		},
